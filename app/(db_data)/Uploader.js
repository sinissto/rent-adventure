...
function Button({ children, onClick, isLoading }) {
  return (
    <button
      className={
        "bg-primary-700 px-8 py-4 text-white font-semibold hover:bg-primary-600 transition-all disabled:cursor-not-allowed disabled:bg-gray-500 disabled:text-gray-300"
      }
      onClick={onClick}
      disabled={isLoading}
    >
